...
def main():
    ...
    # Using your PNG file and also a JPEG file from the internet.
    image_png = Image.open("Hearts/QueenofHearts.png")
    image_jpeg = Image.open("Hearts/queen_of_hearts.jpeg")
